...
import profImage from "../../../../../../public/coding.jpg"

import profImage2 from "../../../../../../public/laptop.jpg";
import profImage3 from "../../../../../../public/img3.jpg";
import profImage4 from "../../../../../../public/me.jpg";
    ...
    <section id="about">
      ...
      >
        ...
        <p className="text-[19px] leading-[40px] text-[#666] md:text-[22px] lg:max-w-[50%]">
          Over the past 3 years, I've collaborated with a diverse range of

...
export default function ContactDetails() {
  ...
  const navLinks = [
    ...
    {
      name: "Linkedin",
      path: "https://www.linkedin.com/in/saif-ali-2059b3184/",
    },

    {
      name: "Instagram",
      path: "https://www.instagram.com/saiiff_alii",
    },

    {
      name: "Github",
      path: "https://github.com/saifxo",
    },
  ];
    ...
    <section className="pt-[80px] xl:pt-[300px]">
      ...
      <div className="flex flex-col xl:flex-row xl:justify-between">
        <div>
          ...
          <p className="py-2 text-[#8a95ad]">Rwp, Pakistan</p>
          <div className="flex items-center gap-2">
            ...
            <Link
              href="mailto:contact.saif4@gmail.com"
              target="_blank"
              className="text-[17px] font-bold text-[#8a95ad]"
            >
              contact.saif4@gmail.com
            </Link>
          </div>
        </div>
      ...
      <p className="pb-10 pt-[100px] text-center text-[#8a95ad]">
        Copyright &copy; {date}{" "}
        <GradientTxt tagName="span" txt="<DevMode/>." /> all rights reserved.
